package com.wedasoft.wedasoftFxGuiCommons.sceneUtil;

import com.wedasoft.wedasoftFxGuiCommons.shared.Scene2Controller;
    ...
    void switchSceneRootTest() throws Exception {
        runOnJavaFxThreadAndJoin(() -> {
            scene = new Scene(FXMLLoader.load(Objects.requireNonNull(getClass().getResource(
                    "/com/wedasoft/wedasoftFxGuiCommons/sceneUtil/scene1.fxml"))));
            stage = new Stage();
        ...
        SceneUtil.switchSceneRoot(
                stage,
                getClass().getResource("/com/wedasoft/wedasoftFxGuiCommons/sceneUtil/scene2.fxml"),
