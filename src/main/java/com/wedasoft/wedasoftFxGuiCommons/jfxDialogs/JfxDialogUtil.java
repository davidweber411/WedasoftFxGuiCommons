...
public class JfxDialogUtil {
     ...
     * @param sceneSize              The scene size. Computes automatically if set to null.
     ...
     */
    public static TextInputDialog createInputDialog(String dialogTitle, String headerText, String contentText) {
     ...
     */
    private static Alert createConfirmDialog(String dialogTitle, String headerText, String contentText) {
